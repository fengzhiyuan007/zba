...
<form action="/Admin/Role/del" method="post" id="form" onsubmit="return checkform()">
<div class="tools"> 
...
<tr class="tabTitleMain">
    ...
    <td width="15%" align="center">角色名</td>
    <td width="10%" align="center">创建时间</td>
    <td width="10%" align="center">操作</td>
</tr>


<?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="tabTextMain" id="f_<?php echo ($l["id"]); ?>" onmouseout="this.style.background='#FFFFFF';" onmouseover="this.style.background='#fbf435';">
  ...
  <td align="center" class="onerow">
                  <a href="/Admin/Role/toupdate/id/<?php echo ($l["id"]); ?>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                  <a href="/Admin/Role/del/chois/<?php echo ($l["id"]); ?>" onclick="return confirm('一旦删除不可修复，确定删除吗？')" >删除</a>
