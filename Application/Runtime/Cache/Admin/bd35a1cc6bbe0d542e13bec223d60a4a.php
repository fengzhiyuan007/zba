...
function xiazai(){
    ...
    window.location.href="/Admin/Caiwu/send_out?act="+download+"&nums="+num+"&start="+start+"&end="+end+"&username="+username+"&status="+status+"&account_binding="+account_binding+"&banned="+banned+"&titles="+titles+"&sex="+sex+"&certification="+certification+"&scope="+scope;
}
function sendname() {
    var num = $("#nus").val();
    var status = $("#status").val();
    ...
    var certification = $("#certification").val();
    var scope = $("#scope").val();
    window.location.href="/Admin/Caiwu/send_out?nums="+num+"&start="+start+"&end="+end+"&username="+username+"&status="+status+"&account_binding="+account_binding+"&banned="+banned+"&titles="+titles+"&sex="+sex+"&certification="+certification+"&scope="+scope;
}
</script>
...
<div class="tools">
    ...
    <span style="float:right;padding-left: 20px">统计送礼钻石:<?php echo ((isset($sum) && ($sum !== ""))?($sum):0); ?>钻石</span>&nbsp;&nbsp;
</div>
    <div class="tools">
...
<tr class="tabTitleMain">
    ...
    <td width="6%" align="center">送出合计</td>
    <td width="6%" align="center">等级</td>
    <td width="12%" align="center">送出时间</td>
