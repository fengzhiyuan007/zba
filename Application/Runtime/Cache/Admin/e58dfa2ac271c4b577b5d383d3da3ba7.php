...
<div class="content">
	<!-----------------------------------------内容开始--------------------------------------------------->
	<div class="infoBox">
		<form name="form" action="/Admin/Base/sensitive_word" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?php echo ($s["id"]); ?>">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				id="basic">
				<tr bgcolor="white">
					<td width="18%" class="infoBoxTd" bgcolor="white">敏感词:</td>
					<td colspan="2">
						<textarea name="sensitive_word" id="sensitive_word" style="width: 750px;height: 200px"><?php echo ($s["sensitive_word"]); ?></textarea><span style="color: red;">注:用英文','隔开!</span>
					</td>
				</tr>
