...
<div class="content">
	...
	<div class="infoBox">
		<form name="form" action="/Admin/Base/qq_auth" method="post">
			<input type="hidden" name="id" value="<?php echo ($base["id"]); ?>">
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				id="basic">
				<tr bgcolor="white">
					<td width="18%" class="infoBoxTd" bgcolor="white">QQ号:</td>
					<td colspan="2">
						<input  id="qq" name="qq" size="60" value="<?php echo ($base["qq"]); ?>">
					</td>
				</tr>
