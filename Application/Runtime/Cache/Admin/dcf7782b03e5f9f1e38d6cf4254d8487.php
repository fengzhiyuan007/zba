...
<div class="content">
	<!-----------------------------------------内容开始--------------------------------------------------->
	<div class="infoBox">
		<form name="form" action="/Admin/Base/withdraw_dis" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="<?php echo ($a["about_us_id"]); ?>">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" id="basic">

				<tr >
					<td  width="2%"  style="text-align:right;color:#2d52a5"><div style="width:55px;">提现说明:</div></td>
					<td colspan="2">
						<textarea id="content3" name="content" style="width:80%;height:280px;"><?php echo ($a["withdraw_dis"]); ?> </textarea>
					</td>
				</tr>
