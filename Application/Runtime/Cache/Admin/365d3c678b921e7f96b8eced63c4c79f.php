...
function getnums(){
    var num = $("#nus").val();
    window.location.href="/Admin/Caiwu/convert_scale?nums="+num;
}
...
<div class="tools"> 
<div class="add"><span><a href="/Admin/Caiwu/toadd_convert_scale">添加</a></span></div>
...
<tr class="tabTitleMain">
    ...
    <td width="15%" align="center">度票</td>
