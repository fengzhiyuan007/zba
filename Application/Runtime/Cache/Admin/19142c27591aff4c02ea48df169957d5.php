...
<!-----------------------------------------内容开始--------------------------------------------------->
<div class="infoBox">
<form name="form" action="/Admin/Menus/update2" method="post"  onsubmit="return check()">

<table width="100%" border="0" cellpadding="0" cellspacing="0" id="basic">
<tr>
	<td width="18%" class="infoBoxTd">菜单名称：</td>
	<td colspan="2"><input size="50" type="text" name="title" value="<?php echo ($vo["title"]); ?>" id='title'></td>
</tr>
<tr>
	<td width="18%" class="infoBoxTd">链接地址：</td>
	<td colspan="2"><input size="50" type="text" name="url" value="<?php echo ($vo["url"]); ?>" id='url'></td>
</tr>
<tr>
	<td width="18%" class="infoBoxTd">状态：</td>
	<td colspan="2">
		<input type="radio" name="status" value="1" id="yes" />启用
		<input type="radio" name="status" value="0" id="no" />禁用

	</td>
</tr>
<tr>
	<td width="18%" class="infoBoxTd">排序：</td>
	<td colspan="2"><input type="text" name="px" value="<?php echo ($vo["px"]); ?>" id='px'></td>
</tr>
</table>
