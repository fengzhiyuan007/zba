                ...
                <div style="width:100%;height:160px;float:left">
                    ...
                    <div style="float:left;padding-left:50px">
                        <ul style="line-height:30px">
                            ...
                            <li>收益：<?php echo ((isset($view["get_money"]) && ($view["get_money"] !== ""))?($view["get_money"]):0); ?> 火力</li>
            ...
            <div class="tab">
                <div class="tab_menu">
                    <ul>
                        ...
                        <a href="<?php echo U('details',array('id'=>$view['user_id'],'state'=>11));?>"><li <?php if( $state == 11 ): ?>class="selected"<?php else: endif; ?>>赠送度票记录</li></a>
                    </ul>
                </div>
                <div class="tab_box">
                ...
                <!--<table width="100%" border="0" cellpadding="0" cellspacing="0" class="">-->
                    ...
                    <!--<?php if(is_array($con)): $i = 0; $__LIST__ = $con;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>-->
                        <!--<tr class="tabTextMain" id="f_<?php echo ($l["id"]); ?>" onmouseout="this.style.background='#FFFFFF';" onmouseover="this.style.background='#fbf435';">-->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="">
    <tr class="tabTitleMain">
        ...
        <td width="10%" align="center">ID</td>
        <td width="10%" align="center">赠送度票数</td>
